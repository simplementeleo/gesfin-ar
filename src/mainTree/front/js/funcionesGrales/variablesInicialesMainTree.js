...
const previsto = { nombre: `previsto`, type: `importe`, maxCaract: 30, validacion: { match: importevalidacion, texto: `Importe Obligatorio` } };
const gastoReal = { nombre: `gastoReal`, type: `importe`, maxCaract: 30, validacion: { match: importevalidacion, texto: `Importe Obligatorio` } };
const pagado = { nombre: `pagado`, type: `importe`, maxCaract: 30, validacion: { match: importevalidacion, texto: `Importe Obligatorio` } };
const aPagar = { nombre: `aPagar`, type: `importe`, maxCaract: 30, validacion: { match: importevalidacion, texto: `Importe Obligatorio` } };
