let variablesIniciales = {
    cobrosRecibidos: {
        atributos: {
            names: [num, unidades, fecha, piso, letra, numer, tipoUnidad, cliente, moneda, tipoCambio, tipoPago, observaciones, adjunto, compuestoCobranza, importeTotal, importeTotalArs, importeTotalUsd, username, date, id, destino],
            titulos: ['Numero', `Fideicomiso`, `Fecha`, `Piso`, `Letra`, `Nro`, `Tipo`, 'Cliente', `Moneda`, `TC`, `Cobro`, `Obrservaciones`, `Ajunto`, `Rubro`, `Descripcion`, `Bruto`, `importeArs`, `importeUsd`, `Cargos`, `otrosImpuestosArs`, `otrosImpuestosUsd`, `Subtotal`, `totalArs`, `totalUsd`, `Total`, `importeTotalArs`, `importeTotalUsd`, 'Usuario', `Aditoria`, `id`],
            soloLectura: [num, estado, tipoCambio, total, importeTotal, date, username],
            oculto: [id, destino, origen, importeArs, importeUsd, otrosImpuestosArs, otrosImpuestosUsd, totalArs, totalUsd, importeTotalArs, importeTotalUsd, idDesen, filename, originalname, path],
            importe: {
                saldo: [],
                totalizadorCabecera: {
                    importeBase: {
                ...
                totalizadorColeccion: {
                    importeBase: {
                        total: [total],
                        cantidad: [],
                        digitosPositivos: [importe, otrosImpuestos],
                        digitosNegativos: []
                    }
                },
                cantidad: [],
                importeBase: [importe, otrosImpuestos, total, importeTotal],
                importePesos: [importeArs, otrosImpuestosArs, totalArs, importeTotalArs],
                importeUsd: [importeUsd, otrosImpuestosUsd, totalUsd, importeTotalUsd],
            },
            compuesto: {
            ...
            configAbm: {
                with: {
                    cuatroCinco: [num, piso, letra, numer, tipoCambio],
                    cinco: [],
                    siete: [tipoPago, date, username, moneda, importe, importeArs, importeUsd, otrosImpuestos, total, importeTotal],
                    diez: [unidades, fecha],
                    quince: [observaciones, tipoUnidad, cliente, rubro],
                }
            },
            modificar: {
                names: [num, unidades, fecha, piso, letra, numer, tipoUnidad, cliente, moneda, tipoCambio, tipoPago, observaciones, adjunto, username, date, id, destino],
                pestanas: [unidades, tipoUnidad, cliente, moneda, tipoPago],
                soloLectura: [num, total, importeTotal, date, username],
        ...
        formInd: {
            ...
            titulosCompuesto: {
                compuestoCobranza: [`Rubro`, `Descripción`, `Bruto`, `importeArs`, `importeUsd`, `Cargos`, `otrosImpuestosArs`, `otrosImpuestosUsd`, `Subtotal`, `totalArs`, `totalUsd`]
            },
            oculto: [id, num, destino, origen, importeArs, importeUsd, otrosImpuestosArs, otrosImpuestosUsd, totalArs, totalUsd, importeTotalArs, importeTotalUsd],
            ...
            modificar: {
                names: [num, unidades, fecha, piso, letra, numer, tipoUnidad, cliente, moneda, tipoCambio, tipoPago, observaciones, adjunto, rubro, descripcion, importe, importeArs, importeUsd, otrosImpuestos, otrosImpuestosArs, otrosImpuestosUsd, total, totalArs, totalUsd, importeTotal, importeTotalArs, importeTotalUsd, username, date, id, destino],
                pestanas: [unidades, tipoUnidad, cliente, rubro, moneda, tipoPago],
                soloLectura: [num, unidades, tc, total, importeTotal, date, username],
            },
            impresion: {
                tituloFormulario: `Recibo`,
                ocultoImpresion: [id, destino, origen, importeArs, importeUsd, otrosImpuestosArs, otrosImpuestosUsd, totalArs, totalUsd, importeTotalArs, importeTotalUsd,],
        ...
        acumulador: [],
        validaciones: [fecha, cliente, rubro, unidades, piso, letra, numer, tipoUnidad, moneda, importe, tipoCambio, tipoPago, adjunto],
        key: {
            atributo: cliente,
            nombre: `cliente`,
        },
